...
model_weights = '/home/cat/projects/roboVision/runs/detect/train25/weights/best.pt'
model = YOLOWorld(model_weights).to(device)
print(model.device.type)
# source = 'http://images.cocodataset.org/val2017/000000039769.jpg'

source = '/home/cat/projects/roboVision/src/yolo/yolo/PXL_20240923_124237061.jpg'
# source = '/home/cat/projects/roboVision/src/yolo/yolo/PXL_20240708_121649628.jpg'
# source = '/home/cat/projects/roboVision/src/yolo/yolo/piz.jpg'
...
# model.set_classes(["lego"])

results = model.predict(source=source, stream=stream, save=save, conf=0.001)
